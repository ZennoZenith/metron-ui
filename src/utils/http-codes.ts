...
export const possible_http_code = [NO_CONTENT, BAD_REQUEST, INTERNAL_SERVER_ERROR] as const;
export type POSSIBLE_HTTP_CODE = typeof possible_http_code[number] | ({} & number);

...
export const API_BASE_ROUTE = env.PUBLIC_API_BASE_ROUTE ?? "http://localhost:8081/api";
export const IMAGE_BASE_ROUTE = env.PUBLIC_IMAGE_BASE_ROUTE ?? "http://192.168.1.20:8082";
